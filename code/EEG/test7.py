...
model.add(Dense(len(emotion_counts), activation='softmax'))
...
plt.title('Model accuracy complex nueral network using Relu')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
...
plt.title('Model loss complex nueral network using Relu')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend(['Train', 'Validation'], loc='upper left')
